...
Function FoundryLiveRuntimeExists
  IfFileExists "$INSTDIR\foundry-local-sdk\prebuilds\win32-${ARCH}\onnxruntime.dll" foundry_live_yes
  IfFileExists "$INSTDIR\foundry-local-sdk\foundry-local-core\win32-${ARCH}\onnxruntime.dll" foundry_live_yes
  Push "no"
  Return
  foundry_live_yes:
    Push "yes"
