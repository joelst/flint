...
- **Audio transcoding gate:** Client-side WebM/Opus and MP3 decoding converts to 16 kHz mono PCM WAV before ingestion using Web Audio or lightweight decoders without heavyweight dependencies.
