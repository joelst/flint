...
From **Settings → About**, an available stable update can be **Install**ed with visible download progress, then **Restart to update** or **Later** (revisit anytime from About).
