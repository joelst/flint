<script lang="ts">
  ...
  function modelSupportsChat(m: any): boolean {
    ...
    if (alias.includes('whisper') || alias.includes('-stt') || alias.includes('stt-') || alias.includes('parakeet') || /nemotron.*(?:speech|asr)/.test(alias)) return false;
  ...
  function modelSupportsAudio(m: any): boolean {
    ...
    return task.includes('automatic-speech-recognition') || task.includes('stt') || caps.includes('automatic-speech-recognition') || alias.includes('whisper') || alias.includes('parakeet') || /nemotron.*(?:speech|asr)/.test(alias);
  }
